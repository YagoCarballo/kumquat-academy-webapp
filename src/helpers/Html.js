...
var En = require('intl/locale-data/jsonp/en.js'); // eslint-disable-line
var Es = require('intl/locale-data/jsonp/es.js'); // eslint-disable-line
    ...
    return (
      <html lang="en-us">
        ...
        <body style={{ height: '100%' }}>
          <div style={{ height: '100%' }} id="content" dangerouslySetInnerHTML={{__html: content}}/>
